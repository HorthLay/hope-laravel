...
<div class="page-header">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="page-subtitle">Write and publish your article</p>
        </div>
    </div>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required oninput="generateSlug()"
            ...
            <div class="card">
                ...
                <div id="video-preview-wrap" class="hidden mt-3">
                    <p class="text-xs text-green-500 mb-2"><i class="fas fa-check-circle mr-1"></i>Valid YouTube URL — preview:</p>
                    <div class="aspect-video rounded-xl overflow-hidden shadow">
                        <iframe id="video-preview-iframe" src="" frameborder="0"
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-1">
                    ...
                    <span id="style-label-display" class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-orange-100 text-orange-600">
                        ...
                        <span id="style-label-text">Overlay</span>
                    </span>
                </div>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="card">
                ...
                <div id="image-preview-container" class="hidden mb-4">
                    ...
                    <p id="image-name" class="text-xs text-gray-400 mt-2 truncate"></p>
                </div>
                <div id="upload-area"
                     class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-orange-400 transition cursor-pointer group"
                    ...
                    <i class="fas fa-cloud-upload-alt text-3xl text-gray-300 group-hover:text-orange-400 mb-2 transition"></i>
                    <p class="text-sm text-gray-500 group-hover:text-orange-500 font-medium">Click or drag to upload</p>
            ...
            <div class="card space-y-3">
                <button type="submit" onclick="document.getElementById('status').value='published'"
                        class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl transition shadow-sm hover:shadow-md">
                    <i class="fas fa-paper-plane"></i> Publish Article
                </button>
                <button type="submit" onclick="document.getElementById('status').value='draft'"
                        class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition">
...
const oldContent=`{!! old('content') !!}`;if(oldContent)quill.root.innerHTML=oldContent;
quill.on('text-change',()=>document.getElementById('content').value=quill.root.innerHTML);
document.getElementById('article-form').addEventListener('submit',function(e){document.getElementById('content').value=quill.root.innerHTML;if(!quill.getText().trim()||quill.getText().trim().length<=1){e.preventDefault();quill.focus();document.querySelector('#content-editor').scrollIntoView({behavior:'smooth',block:'center'});}});
