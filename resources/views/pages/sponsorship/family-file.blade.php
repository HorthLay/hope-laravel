{{-- resources/views/pages/sponsorship/family-file.blade.php --}}
@extends('layouts.app')

@section('title', 'Family Sponsorship — How It Works')
@section('content')
<style>
...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <div class="pill bg-orange-500/20 border border-orange-400/30 text-orange-300 mb-5" style="animation:fadeUp .7s ease both">
            <i class="fas fa-home text-xs"></i> Sponsor a Family
        </div>
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Family Sponsorship<br><span class='text-gradient'>How It Works</span></h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Support an entire family — because a child thrives when their home is stable.</p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div class="reveal-left">
                <div class="pill bg-amber-100 text-amber-700 mb-4"><i class="fas fa-question-circle text-xs"></i> Why a Family?</div>
                <h2 class="text-3xl font-black text-gray-900 mb-5">Holistic Support<br><span class="text-gradient">Starts at Home</span></h2>
                <p class="text-gray-600 leading-relaxed mb-4">A child's well-being is inseparable from the stability of their family. When parents have a safe home, income, and access to healthcare, children thrive. Family sponsorship addresses the root causes of vulnerability, not just the symptoms.</p>
                <p class="text-gray-600 leading-relaxed">Your support provides a family unit with the resources to become self-sufficient — empowering parents to care for their children, access education, and build a sustainable future.</p>
            </div>
            <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-8 border border-amber-100 reveal-right">
                <h3 class="font-black text-gray-800 mb-5 flex items-center gap-2"><i class="fas fa-list-check text-amber-500"></i> What Your Sponsorship Covers</h3>
                <div class="space-y-3">
                    @foreach(['Housing repairs or rental support','Access to healthcare for all family members',"Children's school fees and supplies",'Vocational training for parents','Nutritional support and food security','Psychosocial and emotional support'] as $item)
                    <div class="flex items-center gap-3 p-3 bg-white rounded-xl shadow-sm"><i class="fas fa-check-circle text-amber-500"></i><span class="text-sm font-medium text-gray-700">{{ $item }}</span></div>
                    @endforeach
                </div>
            </div>
        </div>
