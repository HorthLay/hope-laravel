...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <div class="pill bg-orange-500/20 border border-orange-400/30 text-orange-300 mb-5" style="animation:fadeUp .7s ease both">
            <i class="fas fa-graduation-cap text-xs"></i> Children's Education
        </div>
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Education</h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Opening doors to knowledge, opportunity, and a brighter future — one classroom at a time.</p>
    </div>
</section>
...
<section class="section bg-white py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4">
        <div class="reveal mb-10">
            <div class="pill bg-orange-100 text-orange-600 mb-3"><i class="fas fa-circle-dot text-xs"></i> Education</div>
            <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-2">Education</h2>
            <div class="w-20 h-1 bg-orange-500 rounded-full"></div>
        </div>
        <div class="space-y-5">
            <div class="section-card p-7 reveal stagger-1"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-orange-100 flex-shrink-0"><i class="fas fa-school text-orange-500 "></i></div><h3 class="text-lg font-black text-gray-900">Access to School</h3></div><p class="text-gray-600 leading-relaxed">In Cambodia, many vulnerable children do not have access to regular schooling due to poverty, distance, or lack of resources. Des Ailes pour Grandir supports schooling by assisting children and their families so they can attend school and benefit from a stable, continuous learning experience.</p></div>
            <div class="section-card p-7 reveal stagger-2"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-blue-100 flex-shrink-0"><i class="fas fa-book-open text-blue-500 "></i></div><h3 class="text-lg font-black text-gray-900">Academic Support & Learning Development</h3></div><p class="text-gray-600 leading-relaxed">Even when enrolled in school, some children need additional support to progress. We provide tutoring and educational activities tailored to their needs to build confidence and promote academic success.</p></div>
            <div class="section-card p-7 reveal stagger-3"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-green-100 flex-shrink-0"><i class="fas fa-globe text-green-500 "></i></div><h3 class="text-lg font-black text-gray-900">Inclusive Education & Awareness</h3></div><p class="text-gray-600 leading-relaxed">Education goes beyond academic subjects. Des Ailes pour Grandir promotes an inclusive approach incorporating respect for children's rights, awareness of protection, hygiene, and citizenship — preparing children to become responsible adults.</p></div>
            <div class="section-card p-7 reveal stagger-4"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-purple-100 flex-shrink-0"><i class="fas fa-star text-purple-500 "></i></div><h3 class="text-lg font-black text-gray-900">Personal Development</h3></div><p class="text-gray-600 leading-relaxed">Learning also means growing in confidence and autonomy. Our programs include psychosocial and creative activities that stimulate curiosity, strengthen self-esteem, and develop children's social and emotional skills.</p></div>
        </div>
    </div>
</section>
