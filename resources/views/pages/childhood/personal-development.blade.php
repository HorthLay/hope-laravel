...
.hero-h1{font-family: 'Montserrat', sans-serif;font-size:clamp(2.8rem,5.5vw,4.8rem);font-weight:900;line-height:1.02;color:#fff;letter-spacing:-.03em;margin-bottom:22px;}
...
.hero-sub{font-family: 'Montserrat', sans-serif;font-size:.975rem;color:rgba(255,255,255,.52);line-height:1.82;max-width:460px;margin-bottom:38px;}
...
.trait-name{font-family: 'Montserrat', sans-serif;font-size:1rem;font-weight:700;color:#fff;margin-bottom:5px;}
.trait-desc{font-family: 'Montserrat', sans-serif;font-size:11px;color:rgba(255,255,255,.38);line-height:1.55;}
...
.tl-node{
    ...
    font-family: 'Montserrat', sans-serif;font-size:10px;font-weight:900;color:#fff;
...
.tl-cat{display:inline-flex;align-items:center;gap:5px;font-family: 'Montserrat', sans-serif;font-size:9.5px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;padding:4px 12px;border-radius:999px;width:fit-content;margin-bottom:12px;}
.tl-title{font-family: 'Montserrat', sans-serif;font-size:1.45rem;font-weight:900;color:var(--ink);line-height:1.2;margin-bottom:12px;transition:color .2s;}
.tl-card:hover .tl-title{color:var(--or-d);}
.tl-desc{font-family: 'Montserrat', sans-serif;font-size:.875rem;color:var(--muted);line-height:1.78;margin-bottom:20px;}
.tl-link{display:inline-flex;align-items:center;gap:7px;font-family: 'Montserrat', sans-serif;font-size:11px;font-weight:800;letter-spacing:.07em;text-transform:uppercase;text-decoration:none;padding-bottom:1.5px;border-bottom:1.5px solid transparent;transition:border-color .22s,gap .22s;}
...
.val-num{font-family: 'Montserrat', sans-serif;font-size:2rem;font-weight:900;background:linear-gradient(135deg,#f97316,#f59e0b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;line-height:1;margin-bottom:4px;}
.val-label{font-family: 'Montserrat', sans-serif;font-size:11px;font-weight:700;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.09em;}
...
.qs-decor{position:absolute;right:-40px;top:50%;transform:translateY(-50%);font-family: 'Montserrat', sans-serif;font-size:26rem;font-weight:900;color:rgba(255,255,255,.022);line-height:1;pointer-events:none;user-select:none;}
.qs-text{font-family: 'Montserrat', sans-serif;font-style:italic;font-size:clamp(1.35rem,3vw,2rem);font-weight:700;color:#fff;line-height:1.48;max-width:740px;position:relative;z-index:1;}
.qs-text span{color:var(--or);}
.qs-src{font-family: 'Montserrat', sans-serif;font-size:11px;font-weight:700;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.1em;margin-top:18px;position:relative;z-index:1;}
...
<section class="values-band reveal">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <h2 style="font-family: 'Montserrat', sans-serif;font-size:clamp(1.6rem,3.5vw,2.4rem);font-weight:900;color:#fff;letter-spacing:-.02em;">
