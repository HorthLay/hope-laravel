...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Health & Nutrition</h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Building healthy bodies and minds — because a well-nourished child is a child who can learn and dream.</p>
    </div>
</section>
...
<section class="section bg-white py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4">
        <div class="reveal mb-10">
            <div class="pill bg-orange-100 text-orange-600 mb-3"><i class="fas fa-circle-dot text-xs"></i> Health & Nutrition</div>
            <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-2">Health & Nutrition</h2>
            <div class="w-20 h-1 bg-orange-500 rounded-full"></div>
        </div>
        <div class="space-y-5">
            <div class="section-card p-7 reveal stagger-1"><div class="flex items-start gap-5"><div class="icon-badge w-14 h-14 bg-orange-100 flex-shrink-0"><i class="fas fa-stethoscope text-orange-500 text-xl"></i></div><h3 class="text-xl font-black text-gray-900 mb-3">Access to Basic Healthcare</h3></div><div><p class="text-gray-600 leading-relaxed">In Cambodia, access to healthcare remains limited for many children and families, especially in rural or disadvantaged areas. Des Ailes pour Grandir supports access to primary care by funding medical consultations, assisting families, and ensuring regular follow-up to prevent and treat common illnesses.</p></div></div>
            <div class="section-card p-7 reveal stagger-2"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-blue-100 flex-shrink-0"><i class="fas fa-apple-alt text-blue-500 "></i></div><h3 class="text-lg font-black text-gray-900">Nutrition and Food</h3></div><p class="text-gray-600 leading-relaxed">Malnutrition still affects a significant number of Cambodian children, impacting their growth, cognitive development, and long-term health. We provide balanced meals and tailored nutritional support while raising families' awareness of the importance of a healthy diet.</p></div>
            <div class="section-card p-7 reveal stagger-3"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-green-100 flex-shrink-0"><i class="fas fa-hands-wash text-green-500 "></i></div><h3 class="text-lg font-black text-gray-900">Hygiene and Prevention</h3></div><p class="text-gray-600 leading-relaxed">Diseases related to unsafe drinking water, poor sanitation, or inadequate hygiene are common. Des Ailes pour Grandir works to improve hygiene by supporting awareness programs and encouraging preventive practices within families and care centers.</p></div>
            <div class="section-card p-7 reveal stagger-4"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-purple-100 flex-shrink-0"><i class="fas fa-smile text-purple-500 "></i></div><h3 class="text-lg font-black text-gray-900">Overall Well-being</h3></div><p class="text-gray-600 leading-relaxed">Health is not limited to the body: emotional and psychological well-being is essential. Our programs include holistic support, offering educational, recreational, and psychosocial activities to strengthen children's resilience and confidence.</p></div>
        </div>
    </div>
</section>
