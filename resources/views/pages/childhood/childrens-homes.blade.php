...
@section('title', "Support for Children's Homes")
@section('content')
<style>
...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <div class="pill bg-orange-500/20 border border-orange-400/30 text-orange-300 mb-5" style="animation:fadeUp .7s ease both">
            <i class="fas fa-home text-xs"></i> Children's Homes
        </div>
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Support for<br><span class='text-gradient'>Children's Homes</span></h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Strengthening the institutions that give vulnerable children a safe haven every day.</p>
    </div>
</section>
...
<section class="section bg-white py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4">
        <div class="reveal mb-10">
            <div class="pill bg-orange-100 text-orange-600 mb-3"><i class="fas fa-home text-xs"></i> Our Support</div>
            <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-2">How We Support Children's Homes</h2>
            <div class="w-20 h-1 bg-orange-500 rounded-full"></div>
        </div>
        <div class="space-y-5 mb-16">
            <div class="section-card p-7 reveal stagger-1"><div class="flex items-start gap-5"><div class="icon-badge w-14 h-14 bg-orange-100 flex-shrink-0"><i class="fas fa-hands-helping text-orange-500 text-xl"></i></div><h3 class="text-xl font-black text-gray-900 mb-3">Supporting the Structures</h3></div><div><p class="text-gray-600 leading-relaxed">Children's homes and orphanages play a central role in protecting and supporting vulnerable children. Des Ailes pour Grandir supports these institutions by working closely with their staff, providing guidance, monitoring, and operational assistance to strengthen their capacity to meet children's needs.</p></div></div>
            <div class="section-card p-7 reveal stagger-2"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-blue-100 flex-shrink-0"><i class="fas fa-chalkboard-teacher text-blue-500 "></i></div><h3 class="text-lg font-black text-gray-900">Staff Training</h3></div><p class="text-gray-600 leading-relaxed">The quality of care is essential for children's well-being and development. We fund and organize training for staff to improve their skills in education, child protection, health, and psychosocial support.</p></div>
            <div class="section-card p-7 reveal stagger-3"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-green-100 flex-shrink-0"><i class="fas fa-boxes text-green-500 "></i></div><h3 class="text-lg font-black text-gray-900">Provision of Materials and Resources</h3></div><p class="text-gray-600 leading-relaxed">A well-equipped and suitable environment is crucial for children's development. Des Ailes pour Grandir provides educational materials, sanitation equipment, and essential resources, ensuring a safe, stimulating, and comfortable setting for children.</p></div>
            <div class="section-card p-7 reveal stagger-4"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-purple-100 flex-shrink-0"><i class="fas fa-heart text-purple-500 "></i></div><h3 class="text-lg font-black text-gray-900">Enhancing Children's Well-being</h3></div><p class="text-gray-600 leading-relaxed">Beyond material and educational support, our work with children's homes aims to create a protective, warm, and caring environment where each child can grow safely, develop skills, and thrive fully.</p></div>
        </div>
        <div class="reveal mb-6">
            <div class="pill bg-orange-100 text-orange-600 mb-3"><i class="fas fa-map-marker-alt text-xs"></i> Our Locations</div>
            <h2 class="text-2xl font-black text-gray-900 mb-8">Our Children's Homes in Cambodia</h2>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            @foreach([['Kampong Cham','A vibrant city on the Mekong River — our home here supports children in the surrounding communities with education, healthcare, and daily care.','fas fa-water'],['Kampot','In this peaceful riverside town, our home provides a safe haven for the most vulnerable children of the region with full-time residential care and support.','fas fa-mountain']] as $i => $home)
            <div class="section-card bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-100 p-8 reveal stagger-{{ $i+1 }}">
                <div class="flex items-start gap-5 mb-5">
                    <div class="icon-badge w-14 h-14 bg-orange-500 text-white shadow-lg shadow-orange-200"><i class="{{ $home[2] }} text-xl"></i></div>
                    <div><p class="text-xs font-black text-orange-400 uppercase tracking-wider mb-1">Children's Home</p><h3 class="text-2xl font-black text-gray-900">{{ $home[0] }}</h3></div>
                </div>
                <p class="text-sm text-gray-600 leading-relaxed mb-6">{{ $home[1] }}</p>
                <a href="#" class="inline-flex items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-black rounded-xl transition shadow-md shadow-green-200"><i class="fas fa-eye text-sm"></i> Discover This Home</a>
            </div>
            @endforeach
        </div>
    </div>
