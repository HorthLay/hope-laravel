...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <div class="pill bg-orange-500/20 border border-orange-400/30 text-orange-300 mb-5" style="animation:fadeUp .7s ease both">
            <i class="fas fa-shield-alt text-xs"></i> Child Safety
        </div>
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Child Protection</h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Safeguarding every child's right to safety, dignity, and a future free from exploitation.</p>
    </div>
</section>
...
<section class="section bg-white py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4">
        <div class="reveal mb-10">
            <div class="pill bg-orange-100 text-orange-600 mb-3"><i class="fas fa-circle-dot text-xs"></i> Child Protection</div>
            <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-2">Child Protection</h2>
            <div class="w-20 h-1 bg-orange-500 rounded-full"></div>
        </div>
        <div class="space-y-5">
            <div class="section-card p-7 reveal stagger-1"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-orange-100 flex-shrink-0"><i class="fas fa-hammer text-orange-500 "></i></div><h3 class="text-lg font-black text-gray-900">Child Labor</h3></div><p class="text-gray-600 leading-relaxed">In Cambodia, many children are forced to work to help their families, often in dangerous and strenuous conditions. Des Ailes pour Grandir actively fights against child labor by raising community awareness, supporting families, and protecting the most vulnerable children.</p></div>
            <div class="section-card p-7 reveal stagger-2"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-blue-100 flex-shrink-0"><i class="fas fa-school text-blue-500 "></i></div><h3 class="text-lg font-black text-gray-900">Lack of Schooling</h3></div><p class="text-gray-600 leading-relaxed">Many vulnerable children do not have access to education, limiting their opportunities. Des Ailes pour Grandir supports schooling and educational follow-up, assisting children and strengthening local structures to enable them to learn and develop fully.</p></div>
            <div class="section-card p-7 reveal stagger-3"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-green-100 flex-shrink-0"><i class="fas fa-exclamation-triangle text-green-500 "></i></div><h3 class="text-lg font-black text-gray-900">Violence and Abuse</h3></div><p class="text-gray-600 leading-relaxed">Children may suffer physical, psychological, or sexual violence. Through ChildSafe training, our field team implements concrete prevention actions, raises awareness in communities, and intervenes quickly to protect children and provide appropriate support.</p></div>
            <div class="section-card p-7 reveal stagger-4"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-purple-100 flex-shrink-0"><i class="fas fa-ban text-purple-500 "></i></div><h3 class="text-lg font-black text-gray-900">Trafficking and Exploitation</h3></div><p class="text-gray-600 leading-relaxed">Cambodia faces child trafficking and exploitation for forced labor or sexual purposes. Des Ailes pour Grandir collaborates with local partners, including M'Lop Tapang, to prevent these situations and reintegrate children into a safe environment.</p></div>
            <div class="section-card p-7 reveal stagger-5"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-amber-100 flex-shrink-0"><i class="fas fa-balance-scale text-amber-500 "></i></div><h3 class="text-lg font-black text-gray-900">Children's Rights</h3></div><p class="text-gray-600 leading-relaxed">All our actions are guided by the Convention on the Rights of the Child (CRC, 1989), which guarantees the right to education, protection, health, and well-being. Each project aims to defend these rights and create an environment where children can grow and build their future.</p></div>
            <div class="section-card p-7 reveal stagger-6"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-red-100 flex-shrink-0"><i class="fas fa-shield-check text-red-500 "></i></div><h3 class="text-lg font-black text-gray-900">ChildSafe: Prevention & Safety</h3></div><p class="text-gray-600 leading-relaxed">As a member of the ChildSafe network, our association applies international standards to protect children and prevent all forms of abuse. Our field team has completed the associated training, enabling us to act effectively every day.</p></div>
        </div>
    </div>
</section>
