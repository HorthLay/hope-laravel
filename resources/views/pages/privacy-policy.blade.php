...
.breadcrumb{display:flex;align-items:center;gap:8px;flex-wrap:wrap;font-family:'Outfit',sans-serif;font-size:10px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:rgba(251,191,36,.4);margin-bottom:22px;}
...
.hero-pill{display:inline-flex;align-items:center;gap:8px;padding:7px 18px;border-radius:999px;background:rgba(251,191,36,.08);border:1px solid rgba(251,191,36,.2);font-family:'Outfit',sans-serif;font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--gold);margin-bottom:18px;animation:fadeUp .6s ease both;}
.hero-dot{width:6px;height:6px;border-radius:50%;background:var(--gold);animation:pulse 2s ease-in-out infinite;}

.hero-h1{font-family:'Cormorant Garamond',serif;font-size:clamp(2.4rem,5vw,4rem);font-weight:700;color:#fff;line-height:1.06;letter-spacing:-.02em;margin-bottom:14px;animation:fadeUp .8s ease both;}
...
.hero-sub{font-family:'Outfit',sans-serif;font-size:.95rem;color:rgba(255,255,255,.44);line-height:1.75;max-width:520px;animation:fadeUp .8s .16s ease both;}
...
.toc-title{font-family:'Cormorant Garamond',serif;font-size:1.1rem;font-weight:700;color:var(--ink);margin-bottom:16px;display:flex;align-items:center;gap:8px;}
...
.toc-list li a{font-family:'Outfit',sans-serif;font-size:.85rem;font-weight:600;color:var(--muted);text-decoration:none;display:flex;align-items:center;gap:6px;padding:4px 0;border-bottom:1px solid transparent;transition:color .18s,border-color .18s;}
...
.section-num{width:40px;height:40px;border-radius:12px;flex-shrink:0;background:linear-gradient(135deg,#fbbf24,#f97316);color:#fff;font-family:'Cormorant Garamond',serif;font-size:1.1rem;font-weight:700;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(251,191,36,.35);}
.section-title{font-family:'Cormorant Garamond',serif;font-size:1.5rem;font-weight:700;color:var(--ink);letter-spacing:-.01em;}

.section-body{font-family:'Outfit',sans-serif;font-size:.9rem;color:#374151;line-height:1.82;}
...
.data-table{width:100%;border-collapse:collapse;margin:16px 0;font-family:'Outfit',sans-serif;font-size:.85rem;}
...
.highlight-box{background:linear-gradient(135deg,#fffbf0,#fef3c7);border-left:4px solid var(--gold);border-radius:0 14px 14px 0;padding:18px 22px;margin:18px 0;font-family:'Outfit',sans-serif;font-size:.875rem;color:var(--ink);line-height:1.7;}
.highlight-box i{color:var(--gold-d);margin-right:6px;}

.sec-divider{border:none;border-top:1px solid #f1f5f9;margin:48px 0;}
.last-updated{display:inline-flex;align-items:center;gap:6px;font-family:'Outfit',sans-serif;font-size:11px;font-weight:700;color:var(--muted);background:#f8fafc;padding:6px 14px;border-radius:999px;border:1px solid #e2e8f0;margin-bottom:40px;}
...
.right-title{font-family:'Outfit',sans-serif;font-size:.85rem;font-weight:700;color:var(--ink);margin-bottom:3px;}
.right-desc{font-family:'Outfit',sans-serif;font-size:.78rem;color:var(--muted);line-height:1.55;}
...
<div style="background:var(--cream);padding:64px 0 96px;">
    <div class="legal-wrap">
        ...
        <div class="highlight-box reveal">
            ...
            This Privacy Policy complies with the <strong>General Data Protection Regulation (GDPR)</strong> (EU 2016/679) and applicable French data protection law (Loi Informatique et Libertés).
        </div>
        ...
        <div class="cta-legal reveal">
            ...
            <div class="relative z-10">
                ...
                <h3 style="font-family:'Cormorant Garamond',serif;font-size:1.8rem;font-weight:700;color:#fff;margin-bottom:10px;">Questions about your Privacy?</h3>
                <p style="font-family:'Outfit',sans-serif;color:rgba(255,255,255,.45);font-size:.875rem;max-width:400px;margin:0 auto 24px;line-height:1.75;">Exercise your GDPR rights or ask us anything about how we handle your data.</p>
                <a href="mailto:{{ $contactEmail }}"
                   style="display:inline-flex;align-items:center;gap:9px;padding:14px 30px;background:linear-gradient(135deg,#fbbf24,#f97316);color:#1c1033;font-family:'Outfit',sans-serif;font-size:.875rem;font-weight:800;border-radius:12px;text-decoration:none;box-shadow:0 8px 24px rgba(251,191,36,.35);transition:transform .2s,box-shadow .2s;"
                ...
                <div style="margin-top:16px;">
                    <a href="{{ route('terms') }}" style="font-family:'Outfit',sans-serif;font-size:12px;font-weight:600;color:rgba(251,191,36,.5);text-decoration:none;border-bottom:1px solid rgba(251,191,36,.2);padding-bottom:1px;transition:color .18s,border-color .18s;"
