...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        <nav class="breadcrumb">
            ...
            <span>Families</span>
            <i class="fas fa-chevron-right text-[9px]"></i>
            <span>Housing & Family Stability</span>
        </nav>
        <div class="pill bg-orange-500/20 border border-orange-400/30 text-orange-300 mb-5" style="animation:fadeUp .7s ease both">
            <i class="fas fa-house-user text-xs"></i> Family Homes
        </div>
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Housing & Family Stability</h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">A safe home is the foundation of every child's future.</p>
    </div>
</section>
...
<section class="section bg-white py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4">
        <div class="reveal mb-10">
            <div class="pill bg-amber-100 text-amber-700 mb-3"><i class="fas fa-home text-xs"></i> Family Department</div>
            <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-2">Housing & Family Stability</h2>
            <div class="w-20 h-1 bg-amber-500 rounded-full"></div>
        </div>
        <div class="space-y-5">
            <div class="section-card p-7 reveal stagger-1"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-orange-100 flex-shrink-0"><i class="fas fa-tools text-orange-500 "></i></div><h3 class="text-lg font-black text-gray-900">Housing Reconstruction and Renovation</h3></div><p class="text-gray-600 leading-relaxed">Safe and suitable housing is essential for the well-being and safety of children and their families. Des Ailes pour Grandir supports the renovation and reconstruction of homes, providing durable housing that protects families from environmental risks and improves their quality of life.</p></div>
            <div class="section-card p-7 reveal stagger-2"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-blue-100 flex-shrink-0"><i class="fas fa-home text-blue-500 "></i></div><h3 class="text-lg font-black text-gray-900">Access to Stable Housing</h3></div><p class="text-gray-600 leading-relaxed">Residential stability is a fundamental pillar for children to grow up in a secure environment. We help families find safe and lasting housing, reducing the risks of frequent moves, instability, and social vulnerability.</p></div>
            <div class="section-card p-7 reveal stagger-3"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-green-100 flex-shrink-0"><i class="fas fa-shield-alt text-green-500 "></i></div><h3 class="text-lg font-black text-gray-900">Prevention and Safety</h3></div><p class="text-gray-600 leading-relaxed">Housing is not just about walls: it also involves ensuring safety, hygiene, and a nurturing environment for family life. Des Ailes pour Grandir implements prevention actions, raising families' awareness of best practices and ensuring healthy and protective living conditions for children.</p></div>
            <div class="section-card p-7 reveal stagger-4"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-purple-100 flex-shrink-0"><i class="fas fa-heart text-purple-500 "></i></div><h3 class="text-lg font-black text-gray-900">Strengthening Family Well-being</h3></div><p class="text-gray-600 leading-relaxed">At the heart of our actions is comprehensive family support. We contribute to creating a stable and protective home where children can grow up safely and parents feel supported and guided in their educational role.</p></div>
        </div>
    </div>
</section>
