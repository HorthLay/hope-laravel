{{-- {-- resources/views/pages/families/financial-support.blade.php --} --}}
@extends('layouts.app')

@section('title', 'Financial Support')
@section('content')
<style>
...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <div class="pill bg-orange-500/20 border border-orange-400/30 text-orange-300 mb-5" style="animation:fadeUp .7s ease both">
            <i class="fas fa-coins text-xs"></i> Family Aid
        </div>
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Financial Support</h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Targeted aid that empowers families to break the cycle of poverty and build lasting independence.</p>
    </div>
</section>
...
<section class="section bg-white py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4">
        <div class="reveal mb-10">
            ...
            <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-2">Financial Support</h2>
            <div class="w-20 h-1 bg-amber-500 rounded-full"></div>
        </div>
        <div class="space-y-5">
            <div class="section-card p-7 reveal stagger-1"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-orange-100 flex-shrink-0"><i class="fas fa-hand-holding-usd text-orange-500 "></i></div><h3 class="text-lg font-black text-gray-900">Microloans</h3></div><p class="text-gray-600 leading-relaxed">Small loans with flexible repayment to help families launch or grow income-generating activities, giving parents the financial tools to provide for their children.</p></div>
            <div class="section-card p-7 reveal stagger-2"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-blue-100 flex-shrink-0"><i class="fas fa-gift text-blue-500 "></i></div><h3 class="text-lg font-black text-gray-900">One-Time Grants</h3></div><p class="text-gray-600 leading-relaxed">Immediate financial assistance for urgent needs: medical emergencies, school supplies, housing repairs, or other critical expenses that would otherwise be out of reach.</p></div>
            <div class="section-card p-7 reveal stagger-3"><div class="flex items-center gap-3 mb-3"><div class="icon-badge w-10 h-10 bg-green-100 flex-shrink-0"><i class="fas fa-map-signs text-green-500 "></i></div><h3 class="text-lg font-black text-gray-900">Social Guidance</h3></div><p class="text-gray-600 leading-relaxed">Personalized guidance helping families navigate and access available government and community assistance programs, ensuring no family is left without the support they're entitled to.</p></div>
        </div>
    </div>
</section>
