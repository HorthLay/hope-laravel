{{-- {-- resources/views/pages/families/training-employment.blade.php --} --}}
@extends('layouts.app')
...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <div class="pill bg-orange-500/20 border border-orange-400/30 text-orange-300 mb-5" style="animation:fadeUp .7s ease both">
            <i class="fas fa-briefcase text-xs"></i> Family Employment
        </div>
        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight mb-4" style="animation:fadeUp .9s ease both">Training & Employment</h1>
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Economic autonomy — the key to breaking the cycle of poverty and vulnerability.</p>
    </div>
</section>
...
<section class="section bg-white py-16 md:py-20">
    <div class="max-w-7xl mx-auto px-4">
        <div class="reveal mb-10">
            ...
            <h2 class="text-3xl md:text-4xl font-black text-gray-900 mb-2">Training & Employment</h2>
            <div class="w-20 h-1 bg-amber-500 rounded-full"></div>
        </div>
        <div class="space-y-5">
            <div class="section-card p-7 reveal stagger-1"><div class="flex items-start gap-5"><div class="icon-badge w-14 h-14 bg-orange-100 flex-shrink-0"><i class="fas fa-graduation-cap text-orange-500 text-xl"></i></div><h3 class="text-xl font-black text-gray-900 mb-3">Training and Employment</h3></div><div><p class="text-gray-600 leading-relaxed">Access to professional skills and stable employment is essential for families' autonomy and security. In many Cambodian communities, the lack of training and opportunities limits parents' and young adults' prospects, increasing the risk of poverty and vulnerability for children. Des Ailes pour Grandir supports families by offering practical workshops and training tailored to the local market, while also promoting micro-enterprises to generate sustainable income. Support is individualized, with follow-ups, advice, and mentorship to help each family develop autonomy and strengthen economic stability.</p></div></div>
            <div class="section-card p-7 reveal stagger-2"><div class="flex items-start gap-5"><div class="icon-badge w-14 h-14 bg-blue-100 flex-shrink-0"><i class="fas fa-coins text-blue-500 text-xl"></i></div><h3 class="text-xl font-black text-gray-900 mb-3">Financial Support</h3></div><div><p class="text-gray-600 leading-relaxed">Poverty often prevents families from covering essential needs such as housing, healthcare, food, or education. Des Ailes pour Grandir provides targeted financial support through microloans, one-time grants, or guidance to access available social assistance. Combined with training and professional support, families gain security and independence.</p></div></div>
        </div>
    </div>
</section>
