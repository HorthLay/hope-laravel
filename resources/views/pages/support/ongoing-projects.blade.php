        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="section-card overflow-hidden group reveal stagger-{{ ($i%3)+1 }}">
                ...
                <div class="p-6">
                    ...
                    <div><div class="flex justify-between text-xs mb-1"><span class="font-bold text-gray-600">{{ number_format($project->raised_amount) }}â‚¬ raised</span><span class="font-black text-orange-600">{{ $pct }}%</span></div><div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden"><div class="h-full bg-orange-500 rounded-full" style="width:{{ $pct }}%"></div></div><p class="text-xs text-gray-400 mt-1">Goal: {{ number_format($project->goal_amount) }}â‚¬</p></div>
                    @endif
                </div>
            </div>
            @endforeach
