...
<section class="page-hero" style="min-height:380px">
    ...
    <div class="page-hero-content">
        ...
        <p class="text-lg text-white/80 font-medium max-w-xl" style="animation:fadeUp .9s .15s ease both">Reduce your Impot sur la Fortune Immobiliere while funding meaningful impact for vulnerable children.</p>
    </div>
</section>
    ...
    <div class="bg-blue-50 border border-blue-100 rounded-3xl p-10 mb-12">
        <div class="flex items-start gap-5 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 leading-relaxed">If you are subject to the Impot sur la Fortune Immobiliere (IFI) in France, you can reduce your tax bill by up to 75% of your donation amount - up to a ceiling of €50,000 in tax reduction per year.</p>
            </div>
        </div>
