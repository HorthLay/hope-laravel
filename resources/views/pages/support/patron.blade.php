...
<section class="section bg-white py-16 md:py-20">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
        ...
        <div class="space-y-4">
            @foreach([
                ['bronze',  'Bronze Patron',  'bg-orange-100 border-orange-200 text-orange-700', 'â‚¬1,000 – â‚¬4,999 / year', 'Logo on website, annual report mention, tax receipt.'],
                ['silver',  'Silver Patron',  'bg-gray-100 border-gray-300 text-gray-700', 'â‚¬5,000 – â‚¬14,999 / year', 'All Bronze benefits + featured partner post, quarterly updates.'],
                ['gold',    'Gold Patron',    'bg-yellow-100 border-yellow-300 text-yellow-700', 'â‚¬15,000+ / year', 'All Silver benefits + named project, field visit invitation, press release.'],
            ] as $tier)
