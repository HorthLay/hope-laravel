...
.hero-h1{font-family:'Cormorant Garamond',serif;font-size:clamp(2.8rem,7.5vw,6.5rem);font-weight:700;color:#fff;line-height:.96;letter-spacing:-.02em;margin-bottom:24px;animation:fadeUp .8s ease both;}
...
.type-title{font-family:'Cormorant Garamond',serif;font-size:1.15rem;font-weight:700;color:var(--ink);margin-bottom:8px;letter-spacing:-.01em;}
.type-desc{font-family:'Outfit',sans-serif;font-size:.825rem;color:var(--muted);line-height:1.7;}
...
.step-num{
    ...
    color:#fff;font-family:'Cormorant Garamond',serif;font-size:1.6rem;font-weight:700;
...
.step-title{font-family:'Cormorant Garamond',serif;font-size:1.2rem;font-weight:700;color:#fff;margin-bottom:10px;letter-spacing:-.01em;}
.step-desc{font-family:'Outfit',sans-serif;font-size:.85rem;color:rgba(255,255,255,.45);line-height:1.75;}

/* â•â• CTA LAUNCH BUTTON â•â• */
.launch-btn{
    display:inline-flex;align-items:center;gap:12px;
    padding:20px 48px;border-radius:16px;
    background:linear-gradient(135deg,#fbbf24,#f97316);
    color:#fff;font-family:'Outfit',sans-serif;font-size:1.05rem;font-weight:800;
...
.impact-n{font-family:'Cormorant Garamond',serif;font-size:2.8rem;font-weight:700;background:linear-gradient(135deg,#d97706,#f97316);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;line-height:1;margin-bottom:6px;}
.impact-l{font-family:'Outfit',sans-serif;font-size:11px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.09em;}
...
<section style="background:var(--cream);padding:96px 0;">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="text-center mb-14 reveal">
            ...
            <p style="font-family:'Outfit',sans-serif;font-size:.95rem;color:var(--muted);max-width:540px;margin:0 auto;line-height:1.78;">
...
<section class="steps-bg reveal">
    ...
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="text-center mt-14" id="launch">
            ...
            <p style="font-family:'Outfit',sans-serif;font-size:11px;color:rgba(255,255,255,.28);margin-top:14px;letter-spacing:.06em;">
...
<section class="impact-band reveal">
    <div class="max-w-5xl mx-auto px-4">
        <div class="text-center mb-12">
            <h2 style="font-family:'Cormorant Garamond',serif;font-size:clamp(1.8rem,3.5vw,2.6rem);font-weight:700;color:var(--ink);letter-spacing:-.02em;">
    ...
    <div class="cta-in">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
            <div class="text-white text-center lg:text-left">
                ...
                <p style="font-family:'Outfit',sans-serif;color:rgba(255,255,255,.5);font-size:.9rem;max-width:380px;line-height:1.78;">
